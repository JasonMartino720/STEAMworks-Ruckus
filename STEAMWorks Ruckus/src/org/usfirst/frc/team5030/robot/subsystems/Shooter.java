...
public class Shooter extends Subsystem {
	...
	public void AllOff()
    {
    	Robot.robotmap.LeftShooterMotor.set(0.0);
    	Robot.robotmap.RightShooterMotor.set(0.0);
    ...
    {
    	Robot.robotmap.LeftShooterMotor.set(RPMSetpoint);
    }
    ...
    public void Shoot()
    {
    	...
    	System.out.println("Shooter V " + Robot.robotmap.LeftShooterMotor.get());
